...
//   }
   ...
   public String showCusts(Model model) {
	   
	   List<CustomerEntity> cusList;
	   CustomerEntity c = null;
	   System.out.println("okkkkkkkkkk"+orderService.getCustDetails());
	   
	   cusList= orderService.getCustDetails();
	   
//	   Iterator<CustomerEntity> iterator = cusList.iterator();
//	   
//	   while(iterator.hasNext())  // iterate through all the data until the last record
//		{
//			
//		   CustomerEntity e= iterator.next();
//		   System.out.println("hhhhhhhhhhhhh"+e.getFirstName());
//		}
//	  
//	//  System.out.println("11111111111111111110"+c);
	   
	   model.addAttribute("cusList",orderService.getCustDetails());
      return "showCust";
   }
   // for show product
   
   @RequestMapping(value = "/showOrders/{id}", method = RequestMethod.GET)
   public String showOrders(Model model,@PathVariable("id") int ID) {
	   System.out.println("clickkkkkkkkkkkkkk"+ID);
      model.addAttribute("showOrders", orderService.getOrderItems(ID));
      return "showOrders";
   }
